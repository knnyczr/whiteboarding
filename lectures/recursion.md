...
Packaging either of these solutions for reusability leads us to nest them inside `functions` which one of the key elements in recursion let's refactor the code above as a function:
